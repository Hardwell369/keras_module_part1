...
friendly_name = "GlobalAveragePooling2D - Keras"
doc_url = "https://keras.io/api/layers/pooling_layers/global_average_pooling2d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.GlobalAveragePooling2D(**init_params)(**call_params)
