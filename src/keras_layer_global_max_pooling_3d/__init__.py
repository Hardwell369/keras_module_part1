...
friendly_name = "GlobalMaxPooling3D - Keras"
doc_url = "https://keras.io/api/layers/pooling_layers/global_max_pooling3d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.GlobalMaxPooling3D(**init_params)(**call_params)
