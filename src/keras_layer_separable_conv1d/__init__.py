...
friendly_name = "SeparableConv1D - Keras"
doc_url = "https://keras.io/api/layers/convolution_layers/separable_convolution1d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.SeparableConv1D(**init_params)(**call_params)
