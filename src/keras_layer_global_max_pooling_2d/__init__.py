...
friendly_name = "GlobalMaxPooling2D - Keras"
doc_url = "https://keras.io/api/layers/pooling_layers/global_max_pooling2d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.GlobalMaxPooling2D(**init_params)(**call_params)
