...
friendly_name = "AveragePooling3D - Keras"
doc_url = "https://keras.io/api/layers/pooling_layers/average_pooling3d/"
cacheable = False
...
def run(
    ...
    init_params = dict(
        ...
        strides=parse_tuple_or_int(strides) if strides is not None else None,
        padding=padding,
    ...
    layer = keras.layers.AveragePooling3D(**init_params)(**call_params)
