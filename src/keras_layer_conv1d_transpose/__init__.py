...
friendly_name = "Conv1DTranspose - Keras"
doc_url = "https://keras.io/api/layers/convolution_layers/convolution1d_transpose/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.Conv1DTranspose(**init_params)(**call_params)
