...
friendly_name = "SeparableConv2D - Keras"
doc_url = "https://keras.io/api/layers/convolution_layers/separable_convolution2d/"
cacheable = False
...
def run(
    ...
    init_params = dict(
        ...
        pointwise_regularizer=_none(pointwise_regularizer),
        ...
        pointwise_constraint=_none(pointwise_constraint),
    ...
    layer = keras.layers.SeparableConv2D(**init_params)(**call_params)
