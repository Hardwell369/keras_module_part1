...
friendly_name = "Conv3DTranspose - Keras"
doc_url = "https://keras.io/api/layers/convolution_layers/convolution3d_transpose/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.Conv3DTranspose(**init_params)(**call_params)
