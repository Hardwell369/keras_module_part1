...
friendly_name = "GlobalAveragePooling3D - Keras"
doc_url = "https://keras.io/api/layers/pooling_layers/global_average_pooling3d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.GlobalAveragePooling3D(**init_params)(**call_params)
