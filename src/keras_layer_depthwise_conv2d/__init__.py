...
friendly_name = "DepthwiseConv2D - Keras"
doc_url = "https://keras.io/api/layers/convolution_layers/depthwise_convolution2d/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.DepthwiseConv2D(**init_params)(**call_params)
